...
namespace Drupal\topshelf_theme\Hook;
...
use Drupal\topshelf_theme\RenderCallbacks;
...
/**
 * Contains hook implementations for TopshelfTheme.
 */
final class ThemeHooks {
  ...
  public function themeSettingsFormAlter(array &$form): void {
    ...
    $message = $this->t("See <code>@path</code> to learn how to customize TopshelfTheme's fonts, colors, and components.", [
      '@path' => $this->themeList->getPath('topshelf_theme') . '/CUSTOMIZING.md',
    ]);
  ...
  public function preprocessHtml(array &$variables): void {
    ...
    $variables['topshelf_theme_path'] = $this->requestStack->getCurrentRequest()->getBasePath() . '/' . $this->themeList->getPath('topshelf_theme');
  }
